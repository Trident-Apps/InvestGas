...
class FirstQFragment : Fragment() {
    private var _binding: FirstQuestionFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FirstQuestionFragmentBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            q3Btn.setOnClickListener {
                findNavController().navigate(R.id.secondQFragment)
            }
        }
    }
